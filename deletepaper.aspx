<%@ Page Language="C#" MasterPageFile="~/Remoting.master" AutoEventWireup="true" CodeFile="deletepaper.aspx.cs" Inherits="deletepaper" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:TextBox ID="searchtxt" runat="server" Width="50px"></asp:TextBox>
         ...
         <asp:Button ID="searchbtn" Text="search" runat="server" Width="100px" OnClick="search_Click" />
                     ...
                     <asp:Button ID="paperdelete" Text="Delete this Paper" runat="server" Width="200px" OnClick="paperdelete_Click" />
