<%@ Page Title="" Language="C#" MasterPageFile="~/Remoting.master" AutoEventWireup="true" CodeFile="deljournal.aspx.cs" Inherits="deljournal" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:TextBox ID="searchtxt" runat="server" Width="50px"></asp:TextBox>
     ...
     <asp:Button ID="joudel" Text="Delete" runat="server" Width="100px" OnClick="joudel_Click" />
