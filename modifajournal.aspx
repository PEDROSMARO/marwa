<%@ Page Title="" Language="C#" MasterPageFile="~/Remoting.master" AutoEventWireup="true" CodeFile="modifajournal.aspx.cs" Inherits="modifajournal" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:TextBox ID="searchtxt" runat="server" Width="50px"></asp:TextBox>
     ...
     <asp:Button ID="joumod" Text="Modify Journal" runat="server" Width="100px" OnClick="joudmod_Click" />
